  ...
  return (
    <div className="mx-auto my-8 card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
      <div className="card-body">
        <h2 className="text-center text-3xl font-bold text-[#F06225]">
          Now Registration
        </h2>
        <fieldset className="fieldset">
          <form onSubmit={handleSubmit} className="space-y-1">
            {/* name */}
            <label className="label text-gray-700 font-normal">Name : </label>
            <input
              type="text"
              name="name"
            ...
            />
            {/* register btn */}
            <button className="w-full btn bg-[#F06225] text-white mt-4">
              Register
            </button>
          </form>
        </fieldset>
